  ...
  class Tax_Meta_Class
  {
    ...
    public function __construct($meta_box)
    {
      ...
      if (isset($meta_box['use_with_theme'])) {
        if ($meta_box['use_with_theme'] === true) {
          $this->SelfPath = get_template_directory_uri() . '/';
        } elseif ($meta_box['use_with_theme'] === false) {
          $this->SelfPath = plugins_url('meta_files', plugin_basename(dirname(__FILE__)));
        } else {
     ...
     */
      ...
      if (in_array($taxnow, $this->_meta_box['pages'])) {
        ...
        wp_enqueue_style('tax-meta-clss', $plugin_path . '/css/Taxonomy-meta-class.css');
        // Enqueue Meta Box Scripts
        wp_enqueue_script('tax-meta-clss', $plugin_path . '/js/taxonomy-meta-clss.js', array('jquery'), null, true);
      }
    }
